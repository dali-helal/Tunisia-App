				...
				<div className="container-grid">
					...
					<div className="item">
						<div className="details">
							<h2>Senior Software Engineer ( Python Django )</h2>
							<p>Lorem ipsum dolor sit amet consectetur. Elit amet sapien vitae semper egestas maecenas molestie quam. Mattis ultriciesfacilisis eget ornare nec adipiscing. Quisque quis pellentesque orci eu elementum non.</p>
							<h3>Requirements :</h3>
							<div>
								<p>- Master Docker </p>
								<p>- Master Docker </p>
							...
							<h4 className="price">3500 DT - 5000 DT </h4>
							<h4 className="phone">Phone number 52886446</h4>
